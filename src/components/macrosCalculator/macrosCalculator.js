          ...
          <div className="height-input">
            <div className="height">
              <label className="height-info">
                {system === "imperial" ? "Height (ft):" : "Height (cm):"}
              </label>
              <input
                type="text"
                placeholder="Height"
          ...
          <div className="weight-input">
            <div className="weight">
              <label className="weight-info">
                {system === "imperial" ? "Weight (lbs):" : "Weight (kg):"}
              </label>
              <input
                type="text"
                placeholder="Weight"
        ...
        <div className="row2">
          <div className="physicalActivity-input">
            <div className="physicalActivity">
              ...
              <select
                id="physicalActivity"
                className="input-physicalActivity"
                value={physicalActivity}
                onChange={getPhysicalActivity}
              >
            ...
            <ul>
              ...
              <li>
                <input
                  ...
                  onChange={getGoal}
                />
                <label htmlFor="maintain">Keep weight</label>
              </li>
              <li>
                <input
                  type="radio"
        ...
        <div className="result-macros">
          ...
          <div className="container-box">
            <div className="box">
              ...
              <p>Calories</p>
              <p className="info" id="calories-info">
                {resultCalories} calories per day
              </p>
            </div>
            <div className="box">
              <FontAwesomeIcon icon={faBreadSlice} className="carbs-icon" />
              <p>Carbohydrates</p>
              <p className="info" id="carbs-info">
                {resultCarbs} grams per day
              </p>
            </div>
            <div className="box">
              <FontAwesomeIcon icon={faFish} className="proteins-icon" />
              <p>Proteins</p>
              <p className="info" id="proteins-info">
                {resultProteins} grams per day{" "}
              </p>
            </div>
            <div className="box">
              <FontAwesomeIcon icon={faCheese} className="fats-icon" />
              <p>Fats</p>
              <p className="info" id="fats-info">
                {resultFats} grams per day
              </p>
            </div>
          </div>
        </div>
